...
static const struct sco_client_data client_failure_test = {
...
static void test_connect_transp(const void *test_data)
{
	...
	tester_warn("Connect returned %s (%d), expected %s (%d)", strerror(-err), -err, strerror(scodata->expect_err), scodata->expect_err);
...
int main(int argc, char *argv[])
{
	...
	test_sco("eSCO CVSD - Success", &client_success_test, setup_powered,
							test_connect);

	test_sco("eSCO MSBC - Success", &client_success_test, setup_powered,
							test_connect_transp);

	test_sco_11("SCO CVSD 1.1 - Success", &client_success_test, setup_powered,
							test_connect);

	test_sco_11("SCO MSBC 1.1 - Unsupported", &client_failure_test, setup_powered,
							test_connect_transp);
